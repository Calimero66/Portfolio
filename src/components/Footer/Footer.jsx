            ...
            <footer
                ...
                <div className="container pt-9">
                    ...
                    <div className="mb-6 flex justify-center space-x-2">
                        {/* X / twitter */}
                        <a
                            href="https://twitter.com/Calim_dev"
                            type="button"
                        ...
                        {/* Linkedin */}
                        <a
                            href="https://www.linkedin.com/in/hamza-aboulmaali-793b41273/"
                            type="button"
                            className="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-900"
                            data-twe-ripple-init>
                            <span className="mx-auto [&>svg]:h-5 [&>svg]:w-5">
                        ...
                        {/* Github */}
                        <a
                            href="https://github.com/Calimero66?tab=overview&from=2024-03-01&to=2024-03-14"
                            type="button"
                            className="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-900"
                            data-twe-ripple-init>
                            <span className="mx-auto [&>svg]:h-5 [&>svg]:w-5">
